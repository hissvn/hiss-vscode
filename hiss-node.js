...
var hiss_CCInterp = $hx_exports["hiss"]["CCInterp"] = function(printFunction) {
	...
	this.importFunction(this,$bind(this,this.docs),{ name : "docs", argNames : ["callable"]},hiss_HValue.T);
	this.importFunction(this,$bind(this,this.help),{ name : "help", argNames : []});
	this.importSpecialForm($bind(this,this._if),{ name : "if"});
	var _g5 = $bind(this,this.lambda);
	var isMacro2 = false;
	this.importSpecialForm(function(args,env,cc) {
		_g5(isMacro2,args,env,cc);
	},{ name : "lambda"});
	this.importSpecialForm($bind(this,this.callCC),{ name : "call/cc"});
	this.importSpecialForm($bind(this,this._eval),{ name : "eval"});
	this.importSpecialForm($bind(this,this.bound),{ name : "bound?"});
	this.importCCFunction($bind(this,this._load),{ name : "load!", argNames : ["file"]});
	var _g6 = $bind(this,this.funcall);
	var callInline = false;
	this.importSpecialForm(function(args,env,cc) {
		_g6(callInline,args,env,cc);
	},{ name : "funcall"});
	var _g7 = $bind(this,this.funcall);
	var callInline1 = true;
	this.importSpecialForm(function(args,env,cc) {
		_g7(callInline1,args,env,cc);
	},{ name : "funcall-inline"});
	this.importSpecialForm($bind(this,this.loop),{ name : "loop"});
	this.importSpecialForm($bind(this,this.or),{ name : "or"});
	this.importSpecialForm($bind(this,this.and),{ name : "and"});
	...
	this.importFunction(this,function() {
		return _g8(beginFunction,evalAllFunction,iterateFunction);
	},{ name : "disable-cc!"});
	var _g9 = $bind(this,this.useFunctions);
	...
	this.importFunction(this,function() {
		return _g9(beginFunction1,evalAllFunction1,iterateFunction1);
	},{ name : "enable-cc!"});
	var _g10 = $bind(this,this.useFunctions);
	...
	this.importFunction(this,function() {
		return _g10(beginFunction2,evalAllFunction2,iterateFunction2);
	},{ name : "disable-tail-recursion"});
	var interp = this;
	this.importSpecialForm(function(args,env,cc) {
	...
	this.importCCFunction($bind(this,this.getProperty),{ name : "get-property"});
	this.importCCFunction($bind(this,this.callHaxe),{ name : "call-haxe"});
	this.importCCFunction($bind(this,this._new),{ name : "new"});
	...
	this.importClass(hiss_HStream,"HStream");
	...
	this.importCCFunction($bind(this,this.makeDict),{ name : "dict"});
	this.importFunction(this,function(dict,key) {
		return hiss_HissTools.toDict(dict).get(key);
	},{ name : "dict-get"},hiss_HValue.T);
	this.importFunction(this,function(dict,key,value) {
		hiss_HissTools.toDict(dict).put(key,value);
	},{ name : "dict-set!"},hiss_HValue.T);
	this.importFunction(this,function(dict,key) {
		return hiss_HissTools.toDict(dict).exists(key);
	},{ name : "dict-contains"},hiss_HValue.T);
	this.importFunction(this,function(dict,key) {
		hiss_HissTools.toDict(dict).erase(key);
	},{ name : "dict-erase!"},hiss_HValue.T);
	this.importFunction(this,function() {
		return hiss_HValue.List(_gthis.scriptArgs);
	},{ name : "args"});
	this.importFunction(hiss_HissTools,hiss_HissTools.isInt,{ name : "int?"},hiss_HValue.T);
	this.importFunction(hiss_HissTools,hiss_HissTools.isFloat,{ name : "float?"},hiss_HValue.T);
	this.importFunction(hiss_HissTools,hiss_HissTools.isNumber,{ name : "number?"},hiss_HValue.T);
	this.importFunction(hiss_HissTools,hiss_HissTools.isSymbol,{ name : "symbol?"},hiss_HValue.T);
	this.importFunction(hiss_HissTools,hiss_HissTools.isString,{ name : "string?"},hiss_HValue.T);
	this.importFunction(hiss_HissTools,hiss_HissTools.isList,{ name : "list?"},hiss_HValue.T);
	this.importFunction(hiss_HissTools,hiss_HissTools.isDict,{ name : "dict?"},hiss_HValue.T);
	this.importFunction(hiss_HissTools,hiss_HissTools.isFunction,{ name : "function?"},hiss_HValue.T);
	this.importFunction(hiss_HissTools,hiss_HissTools.isMacro,{ name : "macro?"},hiss_HValue.T);
	this.importFunction(hiss_HissTools,hiss_HissTools.isCallable,{ name : "callable?"},hiss_HValue.T);
	this.importFunction(hiss_HissTools,hiss_HissTools.isObject,{ name : "object?"},hiss_HValue.T);
	this.importFunction(hiss_HissTools,hiss_HissTools.clear,{ name : "clear!"},hiss_HValue.T);
	this.importFunction(hiss_HissTools,hiss_HissTools.iterable,{ name : "iterable", argNames : ["next","has-next"]},hiss_HValue.Nil);
	this.importFunction(hiss_HissTools,hiss_HissTools.iteratorToIterable,{ name : "iterator->iterable", argNames : ["haxe-iterator"]},hiss_HValue.Nil);
	hiss_HissTools.put(this.globals,"StringTools",hiss_HValue.Object("Class",StringTools));
	this.importFunction(StringTools,StringTools.startsWith,{ name : "starts-with"});
	this.importFunction(StringTools,StringTools.endsWith,{ name : "ends-with"});
	this.importFunction(StringTools,StringTools.lpad,{ name : "lpad"});
	this.importFunction(StringTools,StringTools.rpad,{ name : "rpad"});
	this.importFunction(StringTools,StringTools.trim,{ name : "trim"});
	this.importFunction(StringTools,StringTools.ltrim,{ name : "ltrim"});
	this.importFunction(StringTools,StringTools.rtrim,{ name : "rtrim"});
	this.importFunction(hiss_HissTools,hiss_HissTools.version,{ name : "version"});
	if(printFunction != null) {
		this.importFunction(this,printFunction,{ name : "print!", argNames : ["value"]},hiss_HValue.Nil);
	} else {
		this.importFunction(hiss_HissTools,hiss_HissTools.print,{ name : "print!", argNames : ["value"]},hiss_HValue.T);
	}
	this.importFunction(hiss_HissTools,hiss_HissTools.message,{ name : "message!", argNames : ["value"]},hiss_HValue.T);
	this.importFunction(hiss_HissTools,hiss_HissTools.toPrint,{ name : "to-print", argNames : ["value"]},hiss_HValue.T);
	this.importFunction(hiss_HissTools,hiss_HissTools.toMessage,{ name : "to-message", argNames : ["value"]},hiss_HValue.T);
	this.importFunction(hiss_HissTools,hiss_HissTools.$length,{ name : "length", argNames : ["seq"]},hiss_HValue.T);
	this.importFunction(hiss_HissTools,hiss_HissTools.reverse,{ name : "reverse", argNames : ["l"]},hiss_HValue.T);
	this.importFunction(hiss_HissTools,hiss_HissTools.first,{ name : "first", argNames : ["l"]},hiss_HValue.T);
	this.importFunction(hiss_HissTools,hiss_HissTools.rest,{ name : "rest", argNames : ["l"]},hiss_HValue.T);
	this.importFunction(hiss_HissTools,hiss_HissTools.last,{ name : "last", argNames : ["l"]},hiss_HValue.T);
	var interp2 = this;
	this.importFunction(hiss_HissTools,function(a,b) {
		return hiss_HissTools.eq(a,interp2,b);
	},{ name : "eq", argNames : ["a","b"]},hiss_HValue.T);
	this.importFunction(hiss_HissTools,hiss_HissTools.nth,{ name : "nth", argNames : ["l","n"]},hiss_HValue.T);
	this.importFunction(hiss_HissTools,hiss_HissTools.setNth,{ name : "set-nth!", argNames : ["l","n","val"]},hiss_HValue.T);
	this.importFunction(hiss_HissTools,hiss_HissTools.cons,{ name : "cons", argNames : ["val","l"]},hiss_HValue.T);
	this.importFunction(this,$bind(this,this.not),{ name : "not", argNames : ["val"]},hiss_HValue.T);
	this.importFunction(hiss_HissTools,hiss_HissTools.sort,{ name : "sort", argNames : ["l","sort-function"]},hiss_HValue.Nil);
	this.importFunction(hiss_HissTools,hiss_HissTools.range,{ name : "range", argNames : ["start","end"]},hiss_HValue.Nil);
	var start = false;
	this.importFunction(hiss_HissTools,function(list) {
		return hiss_HissTools.alternates(list,start);
	},{ name : "even-alternates"},hiss_HValue.T);
	var start1 = true;
	this.importFunction(hiss_HissTools,function(list) {
		return hiss_HissTools.alternates(list,start1);
	},{ name : "odd-alternates"},hiss_HValue.T);
	this.importFunction(hiss_HaxeTools,hiss_HaxeTools.shellCommand,{ name : "shell-command", argNames : ["cmd"]},hiss_HValue.Nil);
	...
	this.importFunction(hiss_HissTools,hiss_HissTools.symbolName,{ name : "symbol-name", argNames : ["sym"]},hiss_HValue.T);
	this.importFunction(hiss_HissTools,hiss_HissTools.symbol,{ name : "symbol", argNames : ["sym-name"]},hiss_HValue.T);
	this.importSpecialForm($bind(this,this.quote),{ name : "quote"});
	var interp3 = this;
	this.importCCFunction(function(args,env,cc) {
		hiss_VariadicFunctions.add(interp3,args,env,cc);
	},{ name : "+"});
	var interp4 = this;
	this.importCCFunction(function(args,env,cc) {
		hiss_VariadicFunctions.subtract(interp4,args,env,cc);
	},{ name : "-"});
	var interp5 = this;
	this.importCCFunction(function(args,env,cc) {
		hiss_VariadicFunctions.divide(interp5,args,env,cc);
	},{ name : "/"});
	var interp6 = this;
	this.importCCFunction(function(args,env,cc) {
		hiss_VariadicFunctions.multiply(interp6,args,env,cc);
	},{ name : "*"});
	var interp7 = this;
	var type3 = hiss_Comparison.Lesser;
	this.importCCFunction(function(args,env,cc) {
		hiss_VariadicFunctions.numCompare(interp7,type3,args,env,cc);
	},{ name : "<"});
	var interp8 = this;
	var type4 = hiss_Comparison.LesserEqual;
	this.importCCFunction(function(args,env,cc) {
		hiss_VariadicFunctions.numCompare(interp8,type4,args,env,cc);
	},{ name : "<="});
	var interp9 = this;
	var type5 = hiss_Comparison.Greater;
	this.importCCFunction(function(args,env,cc) {
		hiss_VariadicFunctions.numCompare(interp9,type5,args,env,cc);
	},{ name : ">"});
	var interp10 = this;
	var type6 = hiss_Comparison.GreaterEqual;
	this.importCCFunction(function(args,env,cc) {
		hiss_VariadicFunctions.numCompare(interp10,type6,args,env,cc);
	},{ name : ">="});
	var interp11 = this;
	var type7 = hiss_Comparison.Equal;
	this.importCCFunction(function(args,env,cc) {
		hiss_VariadicFunctions.numCompare(interp11,type7,args,env,cc);
	},{ name : "="});
	...
	var interp12 = this;
	this.importCCFunction(function(args,env,cc) {
		hiss_wrappers_HHttp.request(interp12,args,env,cc);
	},{ name : "Http:request"});
	this.importClass(hiss_wrappers_HDate,"Date");
	this.importFunction(this,$bind(this,this.python),{ name : "python", argNames : []});
...
hiss_CCInterp.prototype = {
	...
	,disableTrace: function() {
		if(this.tempTrace == null) {
			haxe_Log.trace("Disabling trace",{ fileName : "src/hiss/CCInterp.hx", lineNumber : 73, className : "hiss.CCInterp", methodName : "disableTrace"});
	...
	,enableTrace: function() {
		if(this.tempTrace != null) {
			haxe_Log.trace("Enabling trace",{ fileName : "src/hiss/CCInterp.hx", lineNumber : 81, className : "hiss.CCInterp", methodName : "enableTrace"});
	...
	,importClass: function(clazz,name,methodNameFunction,getterNameFunction,setterNameFunction) {
		...
		if(this.debugClassImports) {
			haxe_Log.trace("Import " + name,{ fileName : "src/hiss/CCInterp.hx", lineNumber : 107, className : "hiss.CCInterp", methodName : "importClass"});
		}
		...
		if(setterNameFunction == null) {
			setterNameFunction = function(propertyName) {
				return name + ":set-" + hx_strings_Strings.toLowerHyphen(propertyName) + "!";
			};
		}
		...
		while(_g < _g1.length) {
			...
			if(Type.typeof(Reflect.getProperty(dummyInstance,instanceField[0]))._hx_index == 5) {
				...
				if(this.debugClassImports) {
					haxe_Log.trace(translatedName,{ fileName : "src/hiss/CCInterp.hx", lineNumber : 139, className : "hiss.CCInterp", methodName : "importClass"});
				}
				hiss_HissTools.put(this.globals,translatedName,hiss_HValue.Function((function(instanceField) {
				...
				})(instanceField),{ name : translatedName}));
			} else {
				...
				if(StringTools.endsWith(setterTranslatedName,"!")) {
					this.defAlias(hiss_HValue.List([hiss_HValue.Symbol(setterTranslatedName),hiss_HValue.Symbol(HxOverrides.substr(setterTranslatedName,0,setterTranslatedName.length - 1)),hiss_HValue.Symbol("@deprecated")]),this.emptyEnv(),hiss_CCInterp.noCC);
				}
			}
		}
		var _g = 0;
		...
		while(_g < _g1.length) {
			...
			if(Type.typeof(fieldValue[0])._hx_index == 5) {
				...
				if(this.debugClassImports) {
					haxe_Log.trace(translatedName,{ fileName : "src/hiss/CCInterp.hx", lineNumber : 187, className : "hiss.CCInterp", methodName : "importClass"});
				}
				hiss_HissTools.put(this.globals,translatedName,hiss_HValue.Function((function(fieldValue) {
					return function(args,env,cc) {
						var args1 = hiss_HissTools.unwrapList(args,_gthis);
						cc(hiss_HissTools.toHValue(fieldValue[0].apply(null,args1)));
					};
	...
	,importMethod: function(method,meta,callOnReference,keepArgsWrapped,returnInstance) {
		...
		var tmp = hiss_HValue.Function(function(args,env,cc) {
			...
			var tmp1 = hiss_HissTools.unwrapList(hiss_HissTools.rest(args),_gthis,keepArgsWrapped);
	...
	,hissTry: function(args,env,cc) {
		try {
			...
			if(js_Boot.__instanceof(_g1,hiss_HSignal)) {
				throw haxe_Exception.thrown(_g1);
			} else if(hiss_HissTools.$length(args) > 1) {
	...
	,repl: function(useConsoleReader) {
		...
		var historyFile = haxe_io_Path.join([hiss_HissTools.homeDir(),".hisstory"]);
		...
		while(true) {
			...
			try {
				...
				if(js_Boot.__instanceof(_g2,hiss_HSignal)) {
					...
					hiss_HaxeTools.println("Error \"" + _g2 + "\" from `" + hiss_HissTools.toPrint(exp) + "`");
	...
	,trBegin: function(exps,env,cc) {
		...
		if(returnCalled.b || !this.truthy(hiss_HissTools.rest(exps))) {
			cc(value);
		} else {
	...
	,begin: function(exps,env,cc) {
		...
		this.internalEval(hiss_HissTools.first(exps),env,function(result) {
			if(returnCalled.b || !_gthis.truthy(hiss_HissTools.rest(exps))) {
				cc(result);
			} else {
				_gthis.begin(hiss_HissTools.rest(exps),env,cc);
			}
		});
	}
	,specialForm: function(args,env,cc) {
		...
		case 11:
			var _g1 = _g.meta;
			if(_g1.deprecated) {
				hiss_HissTools.message(hiss_HValue.String("Warning! Macro " + _g1.name + " is deprecated."));
			}
			_g.f(hiss_HissTools.rest(args),env,cc);
			break;
		case 12:
			var _g1 = _g.meta;
			if(_g1.deprecated) {
	...
	,funcall: function(callInline,args,env,cc) {
		...
		this.currentEvalAllFunction(args,env,function(values) {
			...
			if(_g._hx_index == 10) {
				var _g1 = _g.meta;
				if(_g1.deprecated) {
					hiss_HissTools.message(hiss_HValue.String("Warning! Function " + _g1.name + " is deprecated."));
				}
				_g.f(hiss_HissTools.rest(values),callInline ? env : _gthis.emptyEnv(),cc);
			} else {
	...
	,evalAll: function(args,env,cc) {
		...
		if(!this.truthy(args)) {
			...
			this.internalEval(hiss_HissTools.first(args),env,function(value) {
				_gthis.evalAll(hiss_HissTools.rest(args),env,function(value2) {
					cc(hiss_HissTools.cons(value,value2));
				});
			});
		}
	}
	...
	,delay: function(args,env,cc) {
		var _gthis = this;
		haxe_Timer.delay(function() {
			_gthis.funcall(false,hiss_HValue.List([hiss_HissTools.first(args)]),env,hiss_CCInterp.noCC);
	...
	,setCallable: function(isMacro,args,env,cc) {
		var _gthis = this;
		this.lambda(isMacro,hiss_HissTools.rest(args),env,function(fun) {
			_gthis.set(hiss_SetType.Global,hiss_HissTools.cons(hiss_HissTools.first(args),hiss_HValue.List([fun])),env,cc);
		},hiss_HissTools.symbolName(hiss_HissTools.first(args)));
	}
	,defAlias: function(args,env,cc) {
		...
		this.internalEval(func,env,function(funcVal) {
			...
			var meta = Reflect.copy(_gthis.metadata(funcVal));
			meta.name = hiss_HissTools.symbolName(alias);
			if(metaSymbols.indexOf("@deprecated") != -1) {
				meta.deprecated = true;
			}
			var newFunc = hiss_HValue.Function(hFunc,meta);
			hiss_HissTools.put(_gthis.globals,hiss_HissTools.symbolName(alias),newFunc);
			cc(newFunc);
		});
	}
	,_if: function(args,env,cc) {
		...
		this.internalEval(hiss_HissTools.first(args),env,function(val) {
			if(_gthis.truthy(val)) {
				_gthis.internalEval(hiss_HissTools.second(args),env,cc);
			} else if(hiss_HissTools.$length(args) > 2) {
				_gthis.internalEval(hiss_HissTools.third(args),env,cc);
			} else {
				cc(hiss_HValue.Nil);
			}
		});
	...
	,lambda: function(isMacro,args,env,cc,name) {
		...
		while(_g1 < _g2.length) {
			...
			var meta;
			try {
				meta = hiss_HissTools.symbolName(paramSymbol);
			} catch( _g3 ) {
		...
		var body = hiss_HissTools.toList(hiss_HissTools.rest(args));
		var _g = 0;
		...
		var hFun = function(fArgs,innerEnv,fCC) {
			...
			_gthis.internalEval(hiss_HissTools.cons(hiss_HValue.Symbol("begin"),hiss_HValue.List(body)),callEnv,fCC);
		};
		cc(isMacro ? hiss_HValue.Macro(hFun,meta) : hiss_HValue.Function(hFun,meta));
	}
	,metadata: function(callable) {
	...
	,docs: function(func) {
		return this.metadata(func).docstring;
	}
	,help: function() {
		var _g = hiss_HissTools.toDict(this.globals).keyValueIterator();
		while(_g.hasNext()) {
			var _g1 = _g.next();
			var value = _g1.value;
			var functionHelp = hiss_HissTools.symbolName(_g1.key);
			try {
				var docs = this.docs(value);
			...
			hiss_HissTools.message(hiss_HValue.String(functionHelp));
		}
	}
	...
	,loop: function(args,env,cc) {
		...
		this.evalAll(hiss_HissTools.alternates(bindings,false),env,function(firstValues) {
			...
			var recur = function(nextValueExps,env,cc) {
				_gthis.evalAll(nextValueExps,env,function(nextVals) {
					nextValues = nextVals;
				});
				recurCalled = true;
			};
			...
			while(true) {
				...
				_gthis.internalEval(hiss_HissTools.cons(hiss_HValue.Symbol("begin"),body),hiss_HissTools.extend(env,hiss_HissTools.destructuringBind(names,_gthis,hiss_HissTools.cons(hiss_HValue.SpecialForm(recur,{ name : "recur"}),values))),function(value) {
					result = value;
				});
				if(!recurCalled) {
					break;
	...
	,getProperty: function(args,env,cc) {
		cc(hiss_HissTools.toHValue(Reflect.getProperty(hiss_HissTools.value(hiss_HissTools.first(args),this,true),hiss_HissTools.toHaxeString(hiss_HissTools.second(args)))));
	}
	,callHaxe: function(args,env,cc) {
		var callOnReference = hiss_HissTools.$length(args) < 4 ? false : this.truthy(hiss_HissTools.nth(args,hiss_HValue.Int(3)));
		...
		var caller = hiss_HissTools.value(hiss_HissTools.first(args),this,callOnReference);
	...
	,callCC: function(args,env,cc) {
		...
		if(hiss_HissTools.$length(args) > 1) {
			hiss_HissTools.toHaxeString(this.eval(hiss_HissTools.first(args),env));
			functionToCall = hiss_HissTools.second(args);
		} else {
			functionToCall = hiss_HissTools.first(args);
		}
		this.funcall(true,hiss_HValue.List([functionToCall,hiss_HValue.Function(function(innerArgs,innerEnv,innerCC) {
			var arg = !_gthis.truthy(innerArgs) ? hiss_HValue.Nil : hiss_HissTools.first(innerArgs);
			cc(arg);
		},{ name : "cc", argNames : ["result"]})]),env,cc);
	}
	...
	,or: function(args,env,cc) {
		...
		while(_g < _g1.length) {
			...
			this.internalEval(_g1[_g++],env,(function(argVal) {
				return function(val) {
					argVal[0] = val;
				};
			})(argVal));
			if(this.truthy(argVal[0])) {
				cc(argVal[0]);
				return;
			}
		}
				...
				case 10:
					...
					_gthis.currentEvalAllFunction(exp,env,function(values) {
						...
						if(_g._hx_index == 10) {
							...
							_g.f(hiss_HissTools.rest(values),_gthis1.emptyEnv(),cc1);
						} else {
							throw haxe_Exception.thrown("Cannot funcall " + Std.string(hiss_HissTools.first(values)));
						}
					});
	...
	,toNativeFunction: function(fun) {
		...
		if(fun._hx_index == 10) {
			...
			if(_g.argNames != null && _g.argNames.length == 0) {
				...
				throw haxe_Exception.thrown("Function $meta.name has no args specified, cannot be converted");
			} else {
				throw haxe_Exception.thrown("Cannot convert non-function $fun to native function");
			}
		} else {
			throw haxe_Exception.thrown("Cannot convert non-function $fun to native function");
		}
...
hiss_HDict.prototype = {
	...
	,keyValueIterator: function() {
		return new hiss_HDictIterator(haxe_ds_StringMap.kvIterator(this.map.h));
	}
	,copy: function() {
		return new hiss_HDict(this.interp,haxe_ds_StringMap.createCopy(this.map.h));
	}
	,get: function(key) {
		var this1 = this.map;
		...
		while(_g < hashMatches.length) {
			...
			++_g;
			if(this.interp.truthy(hiss_HissTools.eq(match.key,this.interp,key))) {
				return match.value;
			}
		}
		return hiss_HValue.Nil;
	...
	,exists: function(key) {
		...
		var hashMatches = this1.h[key1];
		var _g = 0;
		while(_g < hashMatches.length) if(this.interp.truthy(hiss_HissTools.eq(hashMatches[_g++].key,this.interp,key))) {
			return true;
		}
		return false;
	}
	,erase: function(key) {
		...
		while(idx < hashMatches.length) {
			if(this.interp.truthy(hiss_HissTools.eq(hashMatches[idx].key,this.interp,key))) {
...
var hiss_HValue = $hxEnums["hiss.HValue"] = { __ename__ : "hiss.HValue", __constructs__ : ["Int","Float","Symbol","InterpString","String","Nil","Null","T","List","Dict","Function","Macro","SpecialForm","Object","Quote","Quasiquote","Unquote","UnquoteList","Comment"]
	...
	,Null: {_hx_index:6,__enum__:"hiss.HValue",toString:$estr}
	,T: {_hx_index:7,__enum__:"hiss.HValue",toString:$estr}
	,List: ($_=function(l) { return {_hx_index:8,l:l,__enum__:"hiss.HValue",toString:$estr}; },$_.__params__ = ["l"],$_)
	,Dict: ($_=function(n) { return {_hx_index:9,n:n,__enum__:"hiss.HValue",toString:$estr}; },$_.__params__ = ["n"],$_)
	,Function: ($_=function(f,meta) { return {_hx_index:10,f:f,meta:meta,__enum__:"hiss.HValue",toString:$estr}; },$_.__params__ = ["f","meta"],$_)
	,Macro: ($_=function(f,meta) { return {_hx_index:11,f:f,meta:meta,__enum__:"hiss.HValue",toString:$estr}; },$_.__params__ = ["f","meta"],$_)
	,SpecialForm: ($_=function(f,meta) { return {_hx_index:12,f:f,meta:meta,__enum__:"hiss.HValue",toString:$estr}; },$_.__params__ = ["f","meta"],$_)
	,Object: ($_=function(t,v) { return {_hx_index:13,t:t,v:v,__enum__:"hiss.HValue",toString:$estr}; },$_.__params__ = ["t","v"],$_)
	,Quote: ($_=function(exp) { return {_hx_index:14,exp:exp,__enum__:"hiss.HValue",toString:$estr}; },$_.__params__ = ["exp"],$_)
	,Quasiquote: ($_=function(exp) { return {_hx_index:15,exp:exp,__enum__:"hiss.HValue",toString:$estr}; },$_.__params__ = ["exp"],$_)
	,Unquote: ($_=function(exp) { return {_hx_index:16,exp:exp,__enum__:"hiss.HValue",toString:$estr}; },$_.__params__ = ["exp"],$_)
	,UnquoteList: ($_=function(exp) { return {_hx_index:17,exp:exp,__enum__:"hiss.HValue",toString:$estr}; },$_.__params__ = ["exp"],$_)
	,Comment: {_hx_index:18,__enum__:"hiss.HValue",toString:$estr}
};
...
hiss_HissReader.prototype = {
	...
	,setMacroString: function(s,f) {
		this.readTable.put(hiss_HValue.String(s),f);
	...
	,setDefaultReadFunction: function(f) {
		this.readTable.put(hiss_HValue.String(""),f);
	}
	...
	,internalSetMacroString: function(s,f) {
		this.readTable.put(hiss_HValue.String(s),this.hissReadFunction(f,"read-" + s));
		if(this.macroLengths.indexOf(s.length) == -1) {
			this.macroLengths.push(s.length);
		}
		this.macroLengths.sort(function(a,b) {
	...
	,read: function(start,stream) {
		...
		while(_g < _g1.length) {
			...
			if(this.readTable.exists(hiss_HValue.String(couldBeAMacro))) {
				stream.drop(couldBeAMacro);
				stream.position();
				var expression = null;
				expression = this.callReadFunction(this.readTable.get(hiss_HValue.String(couldBeAMacro)),couldBeAMacro,stream);
		...
		return this.callReadFunction(this.readTable.get(hiss_HValue.String("")),"",stream);
	}
...
var hiss_HissTestCase = function(hissFile,ignoreFunctions) {
...
hiss_HissTestCase.testAtRuntime = function(interp,args,env,cc) {
	var instance = new hiss_HissTestCase(null,null);
...
hiss_HissTestCase.hissTest = function(interp,args,env,cc) {
	...
	case 8:
		...
		var _g = [];
		var _g2 = 0;
		while(_g2 < _g1.length) _g.push(hiss_HissTools.symbolName(_g1[_g2++]));
	...
	while(_g < _g1.length) {
		...
		try {
			...
			utest_Assert.isTrue(interp.truthy(val),failureMessage + hiss_HissTools.toPrint(val),{ fileName : "src/hiss/HissTestCase.hx", lineNumber : 110, className : "hiss.HissTestCase", methodName : "hissTest"});
		} catch( _g2 ) {
			haxe_NativeStackTrace.lastError = _g2;
			utest_Assert.fail(errorMessage + Std.string(haxe_Exception.caught(_g2).unwrap().toString()),{ fileName : "src/hiss/HissTestCase.hx", lineNumber : 114, className : "hiss.HissTestCase", methodName : "hissTest"});
		}
	}
	var _g = 0;
...
hiss_HissTestCase.hissPrints = function(interp,args,env,cc) {
	...
	interp.importFunction(hiss_HissTools,hiss_HissTools.message,{ name : "message"},hiss_HValue.T);
	var tmp;
	if(expectedPrint == actualPrint || actualPrint.charAt(actualPrint.length - 1) == "\n" && expectedPrint == HxOverrides.substr(actualPrint,0,actualPrint.length - 1)) {
		...
		haxe_Log.trace("\"" + actualPrint + "\" != \"" + expectedPrint + "\"",{ fileName : "src/hiss/HissTestCase.hx", lineNumber : 153, className : "hiss.HissTestCase", methodName : "hissPrints"});
		tmp = hiss_HValue.Nil;
	}
	cc(tmp);
};
hiss_HissTestCase.hissPrintFail = function(v) {
	if(!hiss_HissTestCase.printTestCommands) {
		utest_Assert.fail("Tried to print " + hiss_HissTools.toPrint(v) + " unnecessarily",{ fileName : "src/hiss/HissTestCase.hx", lineNumber : 163, className : "hiss.HissTestCase", methodName : "hissPrintFail"});
	} else {
...
hiss_HissTestCase.failOnTrace = function(interp) {
	...
	haxe_Log.trace = function(str,posInfo) {
		try {
			if(!hiss_HissTestCase.printTestCommands) {
				utest_Assert.fail("Traced " + str + " to console",{ fileName : "src/hiss/HissTestCase.hx", lineNumber : 186, className : "hiss.HissTestCase", methodName : "failOnTrace"});
			} else {
...
hiss_HissTestCase.enableTrace = function(interp) {
	...
	interp.importFunction(hiss_HissTools,hiss_HissTools.print,{ name : "print"},hiss_HValue.T);
};
...
hiss_HissTestCase.prototype = $extend(utest_Test.prototype,{
	...
	,testStdlib: function() {
		...
		if(this.file == null) {
			...
			haxe_Log.trace("Measuring time to construct the Hiss environment:",{ fileName : "src/hiss/HissTestCase.hx", lineNumber : 216, className : "hiss.HissTestCase", methodName : "testStdlib"});
			this.interp = haxe_Timer.measure(function() {
				...
				return i;
			},{ fileName : "src/hiss/HissTestCase.hx", lineNumber : 217, className : "hiss.HissTestCase", methodName : "testStdlib"});
			...
			haxe_Log.trace("Measuring time taken to run the unit tests:",{ fileName : "src/hiss/HissTestCase.hx", lineNumber : 241, className : "hiss.HissTestCase", methodName : "testStdlib"});
			haxe_Timer.measure(function() {
				_gthis.interp.load(_gthis.file);
				haxe_Log.trace("Total time to run tests:",{ fileName : "src/hiss/HissTestCase.hx", lineNumber : 245, className : "hiss.HissTestCase", methodName : "testStdlib"});
			},{ fileName : "src/hiss/HissTestCase.hx", lineNumber : 243, className : "hiss.HissTestCase", methodName : "testStdlib"});
			var _g = [];
			var _g1 = haxe_ds_StringMap.kvIterator(hiss_HissTestCase.functionsTested.h);
			while(_g1.hasNext()) {
				var _g2 = _g1.next();
				if(!_g2.value) {
					_g.push(_g2.key);
...
hiss_HissTools.cons = function(hv,hl) {
	if(hl == hiss_HValue.Nil || hiss_HissTools.$length(hl) == 0) {
...
hiss_HissTools.eq = function(a,interp,b) {
	while(true) {
		...
		case 8:
			...
			var i = 0;
			while(i < l1.length) {
				if(!interp.truthy(hiss_HissTools.eq(l1[i],interp,l2[i]))) {
					return hiss_HValue.Nil;
				}
				++i;
			}
...
hiss_HissTools.toPrint = function(v,recursiveCall) {
	...
	case 8:
		...
		if(recursiveCall > hiss_HissTools.recursivePrintDepth) {
			...
			var valueStr = "";
			var _g1 = 0;
			while(_g1 < _g.length) valueStr += hiss_HissTools.toPrint(_g[_g1++],recursiveCall + 1) + " ";
	...
	case 9:
		if(recursiveCall > hiss_HissTools.recursivePrintDepth) {
			...
			while(_g1.hasNext()) {
				var _g2 = _g1.next();
				_g.push("" + Std.string(_g2.key) + " => " + hiss_HissTools.toPrint(_g2.value,recursiveCall + 1) + ", ");
			}
...
hiss_HissTools.value = function(hv,interp,reference) {
	...
	if(interp == null) {
		haxe_Log.trace(hv,{ fileName : "src/hiss/HissTools.hx", lineNumber : 476, className : "hiss.HissTools", methodName : "value"});
	}
	if(hv == null) {
		return hiss_HValue.Nil;
	}
...
hiss_VariadicFunctions.add = function(interp,args,env,cc) {
	var sum;
	...
	default:
		...
		throw haxe_Exception.thrown(sum1 + $hxEnums[e.__enum__].__constructs__[e._hx_index]);
	}
	var addNext;
	switch(hiss_HissTools.first(args)._hx_index) {
	case 0:
...
hiss_VariadicFunctions.subtract = function(interp,args,env,cc) {
	...
	default:
		...
		var _g = 0;
		var _g1 = hiss_HissTools.unwrapList(hiss_HissTools.rest(args),interp);
		while(_g < _g1.length) first -= _g1[_g++];
		cc(hiss_HissTools.toHValue(first));
	}
};
hiss_VariadicFunctions.divide = function(interp,args,env,cc) {
	switch(hiss_HissTools.$length(args)) {
	case 0:
...
hiss_VariadicFunctions.multiply = function(interp,args,env,cc) {
	while(true) {
		switch(hiss_HissTools.first(args)._hx_index) {
		case 0:
			var product = 1;
			...
			case 4:
				args = hiss_HissTools.cons(hiss_HissTools.toHValue(operands[operands.length - 1]),hiss_HissTools.toHList(operands.slice(0,operands.length - 1)));
				continue;
			case 8:
				args = hiss_HissTools.cons(hiss_HissTools.toHValue(operands[operands.length - 1]),hiss_HissTools.toHList(operands.slice(0,operands.length - 1)));
				continue;
		...
		case 1:
			...
			switch(hiss_HissTools.last(args)._hx_index) {
			case 4:
				args = hiss_HissTools.cons(hiss_HissTools.toHValue(operands1[operands1.length - 1]),hiss_HissTools.toHList(operands1.slice(0,operands1.length - 1)));
				continue;
			case 8:
				args = hiss_HissTools.cons(hiss_HissTools.toHValue(operands1[operands1.length - 1]),hiss_HissTools.toHList(operands1.slice(0,operands1.length - 1)));
				continue;
		...
		case 4:
			...
			if(hiss_HissTools.$length(args) == 2) {
				...
				args = hiss_HissTools.cons(hiss_HValue.String(product2),hiss_HissTools.slice(args,2));
				continue;
			}
			break;
		case 8:
			...
			if(hiss_HissTools.$length(args) == 2) {
				...
				args = hiss_HissTools.cons(hiss_HValue.List(product3),hiss_HissTools.slice(args,2));
				continue;
			}
			break;
		default:
...
hiss_VariadicFunctions.numCompare = function(interp,type,args,env,cc) {
	switch(hiss_HissTools.$length(args)) {
	case 0:
...
var hiss_wrappers_HHttp = function(url) {
	this.instance = new haxe_http_HttpNodeJs(url);
};
hiss_wrappers_HHttp.__name__ = "hiss.wrappers.HHttp";
hiss_wrappers_HHttp.request = function(interp,args,env,cc) {
	var http = hiss_HissTools.value(hiss_HissTools.first(args),interp).instance;
	var post = hiss_HissTools.$length(args) > 1 && hiss_HissTools.value(hiss_HissTools.second(args),interp);
...
hiss_wrappers_HHttp.prototype = {
	...
	,setPostData: function(data) {
		this.instance.setPostData(data);
	}
...
uuid_Uuid.v1 = function(node,optClockSequence,msecs,optNsecs,randomFunc,separator) {
	if(separator == null) {
		separator = "-";
	}
	if(optNsecs == null) {
	...
	return uuid_Uuid.unparse(buffer,separator);
};
uuid_Uuid.v3 = function(name,namespace,separator) {
	if(separator == null) {
		separator = "-";
	}
	if(namespace == null) {
...
uuid_Uuid.v4 = function(randBytes,randomFunc,separator) {
	if(separator == null) {
		separator = "-";
	}
	if(randomFunc == null) {
...
uuid_Uuid.v5 = function(name,namespace,separator) {
	if(separator == null) {
		separator = "-";
	}
	if(namespace == null) {
...
uuid_Uuid.unparse = function(data,separator) {
	if(separator == null) {
		separator = "-";
	}
	var hex = data.toHex();
...
uuid_Uuid.parse = function(data,separator) {
	if(separator == null) {
		separator = "-";
	}
	return haxe_io_Bytes.ofHex(StringTools.replace(data,separator,""));
};
