...
hiss_CCInterp.prototype = {
	...
	,disableTrace: function() {
		if(this.tempTrace == null) {
			haxe_Log.trace("Disabling trace",{ fileName : "src/hiss/CCInterp.hx", lineNumber : 54, className : "hiss.CCInterp", methodName : "disableTrace"});
	...
	,enableTrace: function() {
		if(this.tempTrace != null) {
			haxe_Log.trace("Enabling trace",{ fileName : "src/hiss/CCInterp.hx", lineNumber : 62, className : "hiss.CCInterp", methodName : "enableTrace"});
	...
	,importClass: function(clazz,name,methodNameFunction,getterNameFunction,setterNameFunction) {
		...
		if(this.debugClassImports) {
			haxe_Log.trace("Import " + name,{ fileName : "src/hiss/CCInterp.hx", lineNumber : 84, className : "hiss.CCInterp", methodName : "importClass"});
		}
		...
		while(_g < _g1.length) {
			...
			if(Type.typeof(Reflect.getProperty(dummyInstance,instanceField[0]))._hx_index == 5) {
				...
				if(this.debugClassImports) {
					haxe_Log.trace(translatedName,{ fileName : "src/hiss/CCInterp.hx", lineNumber : 116, className : "hiss.CCInterp", methodName : "importClass"});
				}
		...
		while(_g2 < _g3.length) {
			...
			if(Type.typeof(fieldValue[0])._hx_index == 5) {
				...
				if(this.debugClassImports) {
					haxe_Log.trace(translatedName1,{ fileName : "src/hiss/CCInterp.hx", lineNumber : 160, className : "hiss.CCInterp", methodName : "importClass"});
				}
	...
	,_if: function(args,env,cc) {
		...
		if(hiss_HissTools.$length(args) > 3) {
			throw new js__$Boot_HaxeError("(if) called with too many arguments. Try wrapping the cases in (begin)");
		}
	...
	,getVar: function(name,env,cc) {
		...
		if(v != null) {
			...
			throw new js__$Boot_HaxeError("" + Std.string(name) + " is undefined");
		}
		cc(tmp);
	}
	...
	,callHaxe: function(args,env,cc) {
		...
		if(method == null) {
			throw new js__$Boot_HaxeError("There is no haxe method called " + methodName + " on " + hiss_HissTools.toPrint(hiss_HissTools.first(args)));
		} else {
	...
	,callCC: function(args,env,cc) {
		...
		var ccHFunction = hiss_HValue.Function(function(innerArgs,innerEnv,innerCC) {
			...
			haxe_Log.trace("calling cc#" + ccId + " with " + hiss_HissTools.toPrint(arg),{ fileName : "src/hiss/CCInterp.hx", lineNumber : 950, className : "hiss.CCInterp", methodName : "callCC"});
			cc(arg);
			return;
		},"cc");
	...
	,internalEval: function(exp,env,cc) {
		...
		case 2:
			...
			if(v != null) {
				...
				throw new js__$Boot_HaxeError("" + Std.string(exp) + " is undefined");
			}
			cc(tmp);
			break;
		case 3:
